      ...
      <div className="container mx-auto px-6 text-center lg:text-left flex flex-col lg:flex-row items-center gap-12">
        <div className="flex-1 space-y-6">
          ...
          <p className="max-w-2xl text-gray-400 text-lg lg:text-xl leading-relaxed">
            I'm Michael Rios. I build full-stack applications with
            <span className="text-emerald-400">
              {" "}
              React, TypeScript, and FastAPI
            </span>
            . My most recent project is a SaaS platform called
            <span className="text-white"> PulseCheck</span>, a simple monitoring
            solution for cron jobs and scheduled tasks that emails you the
            instant something stops running. It's live, in production, and
            handling real users today.
          </p>
